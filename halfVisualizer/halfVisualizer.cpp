...
HRESULT STDMETHODCALLTYPE FiletimeVisualizer::EvaluateVisualizedExpression(
...
HRESULT STDMETHODCALLTYPE FiletimeVisualizer::UseDefaultEvaluationBehavior(
    _In_ Evaluation::DkmVisualizedExpression* pVisualizedExpression,
...
HRESULT STDMETHODCALLTYPE FiletimeVisualizer::GetChildren(
    _In_ Evaluation::DkmVisualizedExpression* pVisualizedExpression,
...
HRESULT STDMETHODCALLTYPE FiletimeVisualizer::GetItems(
    _In_ Evaluation::DkmVisualizedExpression* pVisualizedExpression,
...
HRESULT STDMETHODCALLTYPE FiletimeVisualizer::SetValueAsString(
    _In_ Evaluation::DkmVisualizedExpression* pVisualizedExpression,
...
HRESULT STDMETHODCALLTYPE FiletimeVisualizer::GetUnderlyingString(
    _In_ Evaluation::DkmVisualizedExpression* pVisualizedExpression,
...
HRESULT FiletimeVisualizer::FileTimeToText(const FILETIME& fileTime, CString& text)
{
    text.Empty();
